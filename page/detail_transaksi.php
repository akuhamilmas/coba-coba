<?php
  $id_laundry = $_GET['id'];
  // menampilkan data transaksi yang terdiri dari 4 tabel  (join 4 tabel terdiri dari tb_laundry, tb_pelanggan, tb_users, tb_jenis)
...
?>
<!-- dari data yang di gabungkan maka di implementsai ke tampilan dari detail transaksi-->

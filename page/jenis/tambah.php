...
if (isset($_POST['tambah'])) {
  // jika tambah di klik makan akan mengambil  nilai variabel di bawah 
  ...
  // mengecek apakah ada jenis laundry yg sama di database
...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <!-- menampilkan notifikasi pesan error jika ada seperti ada data yang sama seperti di data base-->
      <?php if ($pesan_error !== "") : ?>
        <div class="alert alert-danger" role="alert">
          <?= $pesan_error; ?>
        </div>
      <?php endif; ?>
        <!-- merupakan sama seperti tambah di user dimana kita akan mengisi di kolom yang akan di masukan di data base-->

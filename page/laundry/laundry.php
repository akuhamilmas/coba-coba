            ...
            <table id="datatable" class="table table-bordered">
              ...
              <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                  ...
                  <!-- di bawah ini ada if statment buat keterangan lunas jika status 1 berarti lunas, jika 0 belum lunas -->
                  ...
                  <td>
                    ...
                    <!-- jika status pengen balian 1 sudah diambil 
                  maka langsung mendisabled kolom -->
                  ...
                  <td>
                    <!-- jika status pembayaran = 1, atau status pembayaran nya telah di bayar atau lunas. maka akan tampil tombol detail transaksi dan

  ...
  <div class="row">
      ...
      <?php endif; ?>
          ...
          <div class="card m-b-100">
            <div class="card-body">
            <!--ini inputannya 
          berarti menginput id milik si admin/kasir -->
          ...
          kemudian isi dari id laundry ini terdapat dari varibael di atas
        $id_laundry = 'LD-' . $kd;-->
            <input type="hidden" name="id_laundry" value="<?= $id_laundry; ?>">
            
            <!-- di bawah ini membuat inputan nama pelanggan-->
                ...
                <div class="col-sm-10">
                  ...
                  // query di bawah ini untuk menampilkan selectoption atau combo box milik pelanggan
                    ...
                    <?php endwhile; ?>
                      ...
                      <!-- di bawah ini untuk menampilkan data jenis laundry seperti auto selection di nama pelanggan -->
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="example-text-input" name="catatan" cols="20" rows="5" placeholder="Masukkan catatan" required><?= $catatan; ?></textarea>
                    ...
                    <!-- di bawah ini membuat status lunas yaitu 1 atau 0 -->
              <div class="form-group row">
